...
#a column status that indicates the HTTP status code that the news site sent to the user's
# browser. (Refer to this lesson for more information about the idea of HTTP status codes.)
